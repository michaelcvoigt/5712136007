...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        protected override void FollowTarget(float deltaTime)
        {
			...
			transform.position = Vector3.Lerp(transform.position, CarTarget.transform.position, deltaTime*m_MoveSpeed);

			//Vector3 tempVector3 = new Vector3 (0.0f, 5.0f, 0.0f);

			//transform.position = Vector3.Lerp ( transform.position, tempVector3, deltaTime*m_MoveSpeed);
